...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--hardship", default="data/Hardship_Index_of_Chicago.csv")
    parser.add_argument("--out-data", default="data_processed/model_dataset.csv")
    parser.add_argument("--out-meta", default="data_processed/model_metadata.json")
